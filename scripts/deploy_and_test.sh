...
yellow "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
yellow ""
yellow "AI 自动化测试不能覆盖最后一步：抖音端到端主路径。"
yellow ""
yellow "因为抖音二维码登录必须真人扫码、且 conversation list 是登录后"
yellow "才会渲染，所以 AI 再聪明也跑不通最后这一步。"
yellow ""
yellow "你必须做的最后验证（按顺序）："
yellow "  1. 浏览器访问 http://spark.whoisbot.online (Cmd+Shift+R 强刷)"
yellow "  2. 点 🔑 扫码登录 → 等 ~20s 出现二维码 → 用抖音 App 扫"
yellow "  3. 登录成功后点 🔄 从抖音拉取好友列表 → 等 ~30s"
yellow "  4. 验证：每个会话只出现 1 次，不再 3 列重复"
yellow "  5. 验证：'已缓存 N 位' 的 N 比之前少很多（之前 51，现在 ~50）"
yellow ""
yellow "如果有任何一步失败 → 立刻告诉 AI，AI 才能定位修复。"
yellow ""
yellow "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"